...
const images = {
    ...
    Running:require("./activity_icons/running.png"),
    Football:require("./activity_icons/football.png"),
    Basketball:require("./activity_icons/basketball.png"),
    Rugby:require("./activity_icons/rugby.jpg"),
    Hockey:require("./activity_icons/hockey.png")
